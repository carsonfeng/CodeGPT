...
[![Lint and Testing](https://github.com/carsonfeng/ZCode/actions/workflows/testing.yml/badge.svg?branch=main)](https://github.com/carsonfeng/ZCode/actions/workflows/testing.yml)
[![codecov](https://codecov.io/gh/carsonfeng/ZCode/branch/main/graph/badge.svg)](https://codecov.io/gh/carsonfeng/ZCode)
[![Go Report Card](https://goreportcard.com/badge/github.com/carsonfeng/ZCode)](https://goreportcard.com/report/github.com/carsonfeng/ZCode)
...
* Support [model lists](https://github.com/carsonfeng/ZCode/blob/bf28f000463cfc6dfa2572df61e1b160c5c680f7/openai/openai.go#L18-L38) like `gpt-4`, `gpt-3.5-turbo` ...etc.
...
The pre-compiled binaries can be downloaded from [release page](https://github.com/carsonfeng/ZCode/releases).Change the binary permissions to `755` and copy the binary to the system bin directory. Use the `codegpt` command as shown below.
...
* **openai.model**: default model is `gpt-3.5-turbo`, you can change to `gpt-4` or [other available model list](https://github.com/carsonfeng/ZCode/blob/bf28f000463cfc6dfa2572df61e1b160c5c680f7/openai/openai.go#L18-L38).
...
[![Star History Chart](https://api.star-history.com/svg?repos=carsonfeng/ZCode&type=Date)](https://star-history.com/#carsonfeng/ZCode&Date)
